// https://script.google.com/macros/s/AKfycbyws07xYsxhqJADGiDT-75lnCkYUQ4RqKXaRW55fnx717ZSUH6ImPANg1xXnewJDe3ypw/exec
document
  ...
  .addEventListener("submit", function (event) {
    ...
    resetErrorState(cname, "cnameLabel");
    ...
    if (!cname.value) {
      setErrorState(cname, "cnameLabel");
      isValid = false;
    }
    if (!mobile.value) {
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    resetErrorState(document.getElementById("cname"), "cnameLabel");
    ...
    if (cname === "") {
      setErrorState(document.getElementById("cname"), "cnameLabel");
      isValid = false;
    }
    if (mobile === "") {
